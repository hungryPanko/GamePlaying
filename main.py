...
class startUI(QtWidgets.QWidget):
    def __init__(self):
        ...
        #a = [6, 6, 6, 6, 6, 6] # To do 
        #b = [6, 6, 6, 6, 6, 6]
        a = [nSTONE, nSTONE, nSTONE, nSTONE, nSTONE, nSTONE] 
        b = [nSTONE, nSTONE, nSTONE, nSTONE, nSTONE, nSTONE]
        a_fin = 0;
        b_fin = 0
    ...
    def checkWin(self): # To do Test
        ...
        if a_fin == nSTONE*6 and b_fin == nSTONE*6:
